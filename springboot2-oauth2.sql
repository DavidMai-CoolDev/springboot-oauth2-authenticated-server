...
AUTOAPPROVE VARCHAR(255) DEFAULT NULL
  ...
  constraint valid_access_token
      check (ACCESS_TOKEN_VALIDITY <= 99999999999),
  constraint valid_refresh_token
      check (REFRESH_TOKEN_VALIDITY <= 99999999999)
);
    ...
    CREATE TABLE ROLE
    		...
    		CREATE TABLE PERMISSION_ROLE(
                ...
                CREATE TABLE USERS (
                    ...
                    ACCOUNT_EXPIRED BIT(1) NOT NULL,
                    CREDENTIALS_EXPIRED BIT(1) NOT NULL,
                    ACCOUNT_LOCKED BIT(1) NOT NULL);(3,2);  /* can_read_user assigned to role_user */
INSERT INTO USERs (
    USERNAME,PASSWORD,
    EMAIL,ENABLED,ACCOUNT_EXPIRED,CREDENTIALS_EXPIRED,ACCOUNT_LOCKED) VALUES (
    'admin','{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi',
